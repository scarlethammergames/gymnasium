...
namespace UnitySampleAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonUserControl_Mod : MonoBehaviour
    {
        ...
        {
            if(!jump)
                jump = CrossPlatformInputManager.GetButtonDown(jumpName);
        }
        ...
        private void FixedUpdate()
        {
            ...
            float h = CrossPlatformInputManager.GetAxis(horizontalName);
			float v = CrossPlatformInputManager.GetAxis(verticalName);
