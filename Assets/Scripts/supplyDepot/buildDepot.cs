...
public class buildDepot : MonoBehaviour {
	...
	void Update () {
		...
		UnitySampleAssets.Characters.ThirdPerson.ThirdPersonUserControl_Mod userCtrl = gameObject.GetComponent<UnitySampleAssets.Characters.ThirdPerson.ThirdPersonUserControl_Mod>();
