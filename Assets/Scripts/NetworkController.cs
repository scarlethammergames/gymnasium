...
public class NetworkController : MonoBehaviour
{
  ...
  public int GameState = (int)state.waitserver;
  public int playerCount = 0;
  public bool LANOnly = true;
  public float nextNetworkUpdateTime = 0.0f;
  public GameObject localPlayerObject;
  public Hashtable players = new Hashtable();
  public Vector3 lastLocalPlayerPosition;
  ...
  {
    Network.Connect(ServerAddress, 8093);
  ...
  void StartServer()
  {
    ...
    Network.InitializeServer(16, 8093, useNat);
